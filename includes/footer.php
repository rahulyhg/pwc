    ...
    <footer>
        ...
        <div class="footer-widgets">
            <div class="container">
              <div class="row">
                  <div class="col-lg-3 dt-sc-one-fourth alignright first"> 
                  ...
                  <div class="col-lg-6 dt-sc-one-half aligncenter" style="min-width: 10px"> 
                  <p class="padding20">
                  ...
                  <div class="col-lg-3 dt-sc-one-fourth "> 
                  <aside class="padding20">
                    <h4>Contact us</h4>
                    <p>
